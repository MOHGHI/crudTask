                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Add author
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> Add Author </h4>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                            src="{{old('photo')}}"
                                                            class="rounded-circle height-150" alt="author avatar ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-author"></i> Author info </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
