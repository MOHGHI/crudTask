                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Edit book {{$book->name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-user"></i> Book info </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" name="authors[]" multiple="multiple" id="id_h5_multi">

                                                @isset($authors)
                                                    @foreach($authors as $author)
                                                        <option value="{{$author->id}}" selected>{{$author->last_name}}</option>
                                                    @endforeach
                                                @endisset
